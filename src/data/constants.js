...
"I'm a passionate and versatile developer with a love for problem-solving. As a two-time Chess State Champion and avid Badminton player, I thrive on strategy, focus, and teamwork—qualities I bring to my development work. At Thapar, I’m eager to tackle new challenges, learn continuously, and create impactful solutions with a growth mindset and positive attitude.",
  ...
  resume:
    "https://drive.google.com/file/d/1TGIwyVtcl8UsCEkXrmD1cSpr-1Or5AvR/view?usp=drive_link",
...
export const experiences = [
  {
    ...
    "desc": "Contributed to a team of 10 developers in the development and management of the Urja website. Played a key role in driving the success of the event, helping generate 12+ Lakhs of revenue through registration fees and participation from 25+ top colleges. Ensured smooth user experience, implemented new features, and managed the backend for efficient performance.",
    "skills": [
      "ReactJS",
      "Tailwind CSS",
      "JavaScript",
  ...
  },
  {
    ...
    "desc": "Led ACE 2023 and ACE 2024, managing all aspects of these major conferences and boosting attendee engagement. Executed a high-impact cycling event that drove significant campus participation. Demonstrated strong project management skills by efficiently handling multiple large-scale events.",
    "skills": [
      "Project Management",
      "Event Planning",
      "Team Leadership",
